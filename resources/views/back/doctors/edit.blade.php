                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="phone" id="phone" value="{{ $doctor->phone }}" class="form-control @if ($errors->valid->has('phone')) is-invalid @endif "
                                    data-slugit-target="#slug"> @if ($errors->valid->has('phone'))
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="lastname" id="lastname" value="{{ $doctor->lastname }}" class="form-control @if ($errors->valid->has('lastname')) is-invalid @endif "
