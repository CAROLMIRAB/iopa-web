		...
		<div class="card shadow">
			<div class="card-body">
				...
				<div class="form-group">
						...
						<div data-toggle="modal" data-target="#modal-gallery" id="image-preview" style="background: url('{{ $specialty->image }}'); background-size: cover; background-position: center center; ">
...
<script>
	...
	var image = "<img class='' src='{{ asset('back/img/cloud-upload.pn') }}g' width='60' height='60'/>";
